...
suite('ejs.compile(str, options)', function () {
  ...
  test('empty input users', function () {
    var fn = ejs.compile('');
    assert.equal(fn(), '');
  });
  ...
  test('strict mode users', function () {
...
suite('%>', function () {
  ...
  test('users with `-%>` interspersed', function () {
...
suite('-%>', function () {
  ...
  test('users with unix style', function () {
    var content = '<ul><% -%>\n'
  ...
  test('users with windows style', function () {
    var content = '<ul><% -%>\r\n'
    + '<% users.forEach(function(user){ -%>\r\n'
    + '<li><%= user.name -%></li>\r\n'
    + '<% }) -%>\r\n'
...
suite('require', function () {
  ...
  // Only users with inline/preprocessor includes
